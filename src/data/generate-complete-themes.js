...
console.log('Extracting themes from all departments...\n');
...
// Computer
const computer = extractThemesFromCSV('computerScopusData.csv');
Object.assign(allThemes, computer);
console.log(`✓ Computer: ${Object.keys(computer).length} papers`);
...
// 
// Departments:
// - Civil & Environmental: ${Object.keys(civil).length} papers
// - Computer: ${Object.keys(computer).length} papers
// - Electrical: ${Object.keys(electrical).length} papers
// - Sustainability: ${Object.keys(sustainability).length} papers
// Total: ${total} papers
//
